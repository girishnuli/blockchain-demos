<div
  class="relative bg-gray-50 pt-8 pb-20 px-4 sm:px-6 lg:pt-8 lg:pb-28 lg:px-8"
>
  ...
  <div class="relative max-w-7xl mx-auto">
    <div class="text-center">
      ...
      <p class="mt-3 max-w-2xl mx-auto text-xl text-gray-500 sm:mt-4">
        Learn Blockchain and cryptocurrency concepts through interactive demos.
      </p>
    </div>
    <div class="mt-12 max-w-lg mx-auto grid gap-5 lg:grid-cols-3 lg:max-w-none">
      <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="flex-1 bg-white p-6 flex flex-col justify-between">
          <div class="flex-1">
            <a href="/blockchain-demo" class="block mt-2">
      ...
      <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="flex-1 bg-white p-6 flex flex-col justify-between">
          <div class="flex-1">
            <a href="/accounts-demo" class="block mt-2">
              <p class="text-xl font-semibold text-gray-900">
                Blockchain accounts
              </p>
              <p class="mt-3 text-base text-gray-500">
      ...
      <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="flex-1 bg-white p-6 flex flex-col justify-between">
          <div class="flex-1">
            <a href="/smart-contracts-demo" class="block mt-2">
              <p class="text-xl font-semibold text-gray-900">
                Smart contracts
              </p>
              <p class="mt-3 text-base text-gray-500">
